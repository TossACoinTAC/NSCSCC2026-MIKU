...
set_property IOSTANDARD LVCMOS33 [get_ports LCD_nrst]
set_property IOSTANDARD LVCMOS33 [get_ports LCD_csel]
...
set_false_path -from [get_clocks clk_out2_clk_pll_33] -to [get_clocks mtxclk_0]
set_clock_groups -asynchronous -group [get_clocks UTMI_clk] -group [get_clocks clk_out1_clk_pll_33]
set_clock_groups -asynchronous -group [get_clocks UTMI_clk] -group [get_clocks clk_out2_clk_pll_33]
