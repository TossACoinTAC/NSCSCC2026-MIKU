...
object GenerateRegisteredMultiplier {
  private def outputArgument(args: Array[String]): String =
    args match {
      ...
      case _ =>
        throw new IllegalArgumentException(
          "usage: GenerateRegisteredMultiplier [--out-dir] <output-directory>"
        )
    }
  ...
  def main(args: Array[String]): Unit = {
    ...
    config.generateVerilog {
      val dut = new RegisteredMultiplier
      dut.setDefinitionName("mul")
      dut
    }
  }
}
