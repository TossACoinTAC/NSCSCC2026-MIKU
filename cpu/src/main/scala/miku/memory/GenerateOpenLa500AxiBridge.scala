...
object GenerateOpenLa500AxiBridge {
  private def outputArgument(args: Array[String]): String =
    args match {
      ...
      case _ =>
        throw new IllegalArgumentException(
          "usage: GenerateOpenLa500AxiBridge [--out-dir] <output-directory>"
        )
    }
  ...
  def main(args: Array[String]): Unit = {
    ...
    config.generateVerilog {
      val dut = new OpenLa500AxiBridge
      dut.setDefinitionName("axi_bridge")
      dut
    }
  }
}
